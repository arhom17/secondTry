...
colSums(deaths[795:893,c(14:84)]) -> deathSubIA
...
colSums(confirmed[795:893,c(13:83)]) -> confirmedSubIA
...
combinedIA$date <- seq(from = as.Date("2020-01-23"), to = as.Date("2020-04-02"), by = 'day')
...
combinedIA %>% gf_line(CurrentEstimate ~ date, color = "ORANGE") %>% gf_line(confirmedSub ~ date, color = "RED")
